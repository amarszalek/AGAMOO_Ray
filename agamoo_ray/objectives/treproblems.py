...
class RE21(Objective):
    ...
    def evaluate(self, x):
        ...
        if self.obj == 0:
            time.sleep(0.001*x.shape[0]/50)
            return L * ((2 * x[:,0]) + np.sqrt(2.0) * x[:,1] + np.sqrt(x[:,2]) + x[:,3])
        elif self.obj == 1:
            time.sleep(0.0012*x.shape[0]/50)
...
class RE22(Objective):
    ...
    def evaluate(self, x):
        ...
        if self.obj == 0:
            ...
            time.sleep(0.0017*x.shape[0]/50)
...
class RE24(Objective):
    ...
    def evaluate(self, x):
        ...
        if self.obj == 0:
            ...
            time.sleep(0.0150*x.shape[0]/50)
            E = 700000
            sigma_b_max = 700
            tau_max = 450
            delta_max = 1.5
...
class RE25(Objective):
    ...
    def evaluate(self, x):
        ...
        if self.obj == 0:
            ...
            time.sleep(0.0047*x.shape[0]/50)
...
class RE31(Objective):
    ...
    def evaluate(self, x):
        ...
        # First original objective function
        if self.obj == 0:
            time.sleep(0.0014*x.shape[0]/50)
            ...
            time.sleep(0.0063*x.shape[0]/50)
            # Constraint functions
...
class RE32(Objective):
    ...
    def evaluate(self, x):
        ...
        if self.obj == 0:
            ...
            time.sleep(0.0144*x.shape[0]/50)
            # Constraint functions
            M = P * (L + (x2 / 2))
...
class RE33(Objective):
    ...
    def evaluate(self, x):
        ...
        if self.obj == 0:
            ...
            time.sleep(0.0016*x.shape[0]/50)
            # Second original objective function
            return ((9.82 * 1e6) * (x2 * x2 - x1 * x1)) / (x3 * x4 * (x2 * x2 * x2 - x1 * x1 * x1))
        elif self.obj == 2:
            time.sleep(0.0081*x.shape[0]/50)
...
class RE34(Objective):
    ...
    def evaluate(self, x):
        if self.obj == 0:
            ...
            time.sleep(0.0025*x.shape[0]/50)
            ...
            time.sleep(0.0026*x.shape[0]/50)
...
class RE35(Objective):
    ...
    def evaluate(self, x):
        ...
        if self.obj == 0:
            time.sleep(0.0022*x.shape[0]/50)
            ...
            time.sleep(0.0097*x.shape[0]/50)
            # Constraint functions 	
            tmpVar = np.power((745.0 * x4) / (x2 * x3), 2.0)  + 1.69 * 1e7
...
class RE36(Objective):
    ...
    def evaluate(self, x):
        ...
        if self.obj == 0:
            ...
            time.sleep(0.0013*x.shape[0]/50)
...
class RE41(Objective):
    ...
    def evaluate(self, x):
        ...
        if self.obj == 0:
            time.sleep(0.0023*x.shape[0]/50)
            # First original objective function
...
class RE61(Objective):
    ...
    def evaluate(self, x):
        if self.obj == 0:
            time.sleep(0.0020*x.shape[0]/50)
            ...
            time.sleep(0.0042*x.shape[0]/50)
            return 250 * 2289 * np.exp(-39.75*x[:, 1]+9.9*x[:, 2]+2.74)
        elif self.obj == 4:
            time.sleep(0.0044*x.shape[0]/50)
            return 25 * (1.39 /(x[:, 0]*x[:, 1]) + 4940*x[:, 2] -80)
        elif self.obj == 5:
            time.sleep(0.0480*x.shape[0]/50)
...
class RE91(Objective):
    ...
    def evaluate(self, x):
        ...
        if self.obj == 0:
            ...
            time.sleep(0.0028*x.shape[0]/50)
            # Sixth function       
            ...
            time.sleep(0.0011*x.shape[0]/50)
